    ...
    <main class="main mt-0 pb-2 pb-lg-4 position-relative">
        ...
        <section class="height-content banner-shape">
            <figure class="banner-container position-relative mb-0">
                <img src="/build/img/pexels-tom-fisk-2101137 (4).jpg" alt="баннер" class="w-100 banner-img img-fluid obj-fit-top position-relative">
        ...
        <!-- content -->
        <section class="bg-transparent d-flex flex-column fustify-content-between align-items-center mx-3 mx-sm-0 mt-3 mt-lg-4">
            <article class="container mx-0 bg-light shadow border px-0 mb-3">
                <section class="p-3">
                    ...
                    <p class="lead mb-0 text-justify text-indent content__text">
            ...
            <article class="container mx-0 bg-light shadow border mb-3 px-0">
                <section class="p-3">
                    ...
                    <p class="lead mb-0 text-justify text-indentn content__text">
                    ...
                    <p class="lead text-justify mb-0 text-indent content__text">
